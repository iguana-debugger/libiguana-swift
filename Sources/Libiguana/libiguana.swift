...
open class IguanaEnvironment:
     ...
     * directory.
     */
public convenience init(jimulatorPath: String, aasmPath: String, mnemonicsPath: String) {
    let pointer = throws try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func compileAasm(aasmPath: String)throws  -> AasmOutput {
    return try  FfiConverterTypeAasmOutput.lift(try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func continueExecution()throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
    uniffi_libiguana_fn_method_iguanaenvironment_continue_execution(self.uniffiClonePointer(),$0
    )
}
}
    
open func createNewBreakpoint(memoryAddress: UInt32)throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func currentKmd() -> [KmdparseToken]? {
    return try!  FfiConverterOptionSequenceTypeKmdparseToken.lift(try! rustCall() {
     ...
     * because for some reason `Drop` isn't working through `uniffi`.
     */
open func killJimulator()throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
     ...
     * function.
     */
open func loadKmd(kmd: String)throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func pause()throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
    uniffi_libiguana_fn_method_iguanaenvironment_pause(self.uniffiClonePointer(),$0
    )
}
}
    
open func ping()throws  -> String {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
    uniffi_libiguana_fn_method_iguanaenvironment_ping(self.uniffiClonePointer(),$0
    )
})
}
    
open func readMemory(address: UInt32)throws  -> U84Arr {
    return try  FfiConverterTypeU84Arr.lift(try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func readToEnd()throws  -> Data {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
    uniffi_libiguana_fn_method_iguanaenvironment_read_to_end(self.uniffiClonePointer(),$0
    )
})
}
    
open func registers()throws  -> Registers {
    return try  FfiConverterTypeRegisters.lift(try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
    uniffi_libiguana_fn_method_iguanaenvironment_registers(self.uniffiClonePointer(),$0
    )
})
}
    
open func reset()throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
     ...
     * execute indefinitely.
     */
open func startExecution(steps: UInt32)throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func status()throws  -> BoardState {
    return try  FfiConverterTypeBoardState.lift(try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
    uniffi_libiguana_fn_method_iguanaenvironment_status(self.uniffiClonePointer(),$0
    )
})
}
    
open func stopExecution()throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
    uniffi_libiguana_fn_method_iguanaenvironment_stop_execution(self.uniffiClonePointer(),$0
    )
}
}
    
open func terminalMessages()throws  -> Data {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func traps() -> [UInt32: UInt8] {
    return try!  FfiConverterDictionaryUInt32UInt8.lift(try! rustCall() {
     ...
     * Writes the given byte array to the jimulator process.
     */
open func write(payload: Data)throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func writeMemory(word: Data, address: UInt32)throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
open func writeToTerminal(message: Data)throws  {try rustCallWithError(FfiConverterTypeLibiguanaError.lift) {
...
public struct AasmOutput {
    ...
    public init(kmd: String, aasmTerminal: String) {
        self.kmd = kmd
...
public struct BoardState {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(status: Status, stepsRemaining: UInt32, stepsSinceReset: UInt32) {
        self.status = status
...
public struct KmdparseLine {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(memoryAddress: UInt32?, word: KmdparseWord?, comment: String) {
        self.memoryAddress = memoryAddress
        self.word = word
...
public struct Registers {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(r0: UInt32, r1: UInt32, r2: UInt32, r3: UInt32, r4: UInt32, r5: UInt32, r6: UInt32, r7: UInt32, r8: UInt32, r9: UInt32, r10: UInt32, r11: UInt32, r12: UInt32, r13: UInt32, r14: UInt32, pc: UInt32) {
        self.r0 = r0
        self.r1 = r1
        self.r2 = r2
        self.r3 = r3
...
public enum KmdparseToken {
    ...
    case tag
    case line(line: KmdparseLine
    )
    case label(label: KmdparseLabel
    )
}
...
public struct FfiConverterTypeKmdparseToken: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> KmdparseToken {
        ...
        case 2: return .line(line: try FfiConverterTypeKmdparseLine.read(from: &buf)
        )
        
        case 3: return .label(label: try FfiConverterTypeKmdparseLabel.read(from: &buf)
        )
...
public enum KmdparseWord {
     ...
     */
    case instruction(instruction: U84Arr
    )
    case data(data: Data
    )
}
...
public struct FfiConverterTypeKmdparseWord: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> KmdparseWord {
        ...
        case 1: return .instruction(instruction: try FfiConverterTypeU84Arr.read(from: &buf)
        )
        
        case 2: return .data(data: try FfiConverterData.read(from: &buf)
        )
...
private var initializationResult: InitializationResult {
    ...
    if (uniffi_libiguana_checksum_method_iguanaenvironment_compile_aasm() != 50390) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_libiguana_checksum_method_iguanaenvironment_continue_execution() != 23014) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_libiguana_checksum_method_iguanaenvironment_create_new_breakpoint() != 3485) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_libiguana_checksum_method_iguanaenvironment_load_kmd() != 10274) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_libiguana_checksum_method_iguanaenvironment_read_memory() != 44216) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_libiguana_checksum_method_iguanaenvironment_start_execution() != 160) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_libiguana_checksum_method_iguanaenvironment_write() != 33605) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_libiguana_checksum_method_iguanaenvironment_write_memory() != 27179) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_libiguana_checksum_method_iguanaenvironment_write_to_terminal() != 9728) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_libiguana_checksum_constructor_iguanaenvironment_new() != 9665) {
        return InitializationResult.apiChecksumMismatch
    }
