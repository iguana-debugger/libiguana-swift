...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_kmdparse_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_kmdparse_rustbuffer_free(self, $0) }
    }
}
...
public struct FfiConverterTypeLine: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Line {
        return
            try Line(
                ...
                word: FfiConverterOptionTypeWord.read(from: &buf), 
    ...
    public static func write(_ value: Line, into buf: inout [UInt8]) {
        ...
        FfiConverterOptionTypeWord.write(value.word, into: &buf)
...
public struct FfiConverterTypeToken: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Token {
        ...
        case 2: return .line(
            line: try FfiConverterTypeLine.read(from: &buf)
        )
        
        case 3: return .label(
            label: try FfiConverterTypeLabel.read(from: &buf)
        )
    ...
    public static func write(_ value: Token, into buf: inout [UInt8]) {
        ...
        case let .line(line):
            ...
            FfiConverterTypeLine.write(line, into: &buf)
            
        
        case let .label(label):
            writeInt(&buf, Int32(3))
            FfiConverterTypeLabel.write(label, into: &buf)
...
fileprivate struct FfiConverterOptionTypeWord: FfiConverterRustBuffer {
    typealias SwiftType = Word?
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeWord.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeWord.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
private var initializationResult: InitializationResult {
    ...
    let scaffolding_contract_version = ffi_kmdparse_uniffi_contract_version()
